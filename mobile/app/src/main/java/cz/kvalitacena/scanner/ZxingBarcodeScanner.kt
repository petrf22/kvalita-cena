 ...
 * Google Play Services, což jde proti principu jen svobodných knihoven (CLAUDE.md,
 * "Konvence") a proti tomu, že o uživatelích nemá vědět třetí strana. Pokud by čtení
