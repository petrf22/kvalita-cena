...
type Documents = {
    ...
    "\n      query FeedbackChallenge {\n        feedbackChallenge {\n          token\n          salt\n          difficulty\n        }\n      }\n    ": typeof types.FeedbackChallengeDocument,
...
const documents: Documents = {
    ...
    "\n      query FeedbackChallenge {\n        feedbackChallenge {\n          token\n          salt\n          difficulty\n        }\n      }\n    ": types.FeedbackChallengeDocument,
    ...
    "\n  fragment ProductReviewFields on ProductReview {\n    id\n    stars\n    text\n    authorPublicUid\n    authorName\n    createdAt\n    updatedAt\n    mine\n  }\n": types.ProductReviewFieldsFragmentDoc,
    ...
    "\n      query DuplicateCandidates($first: Int, $offset: Int) {\n        duplicateCandidates(first: $first, offset: $offset) {\n          totalCount\n          items {\n            score\n            left {\n              ...ProductSummaryFields\n            }\n            right {\n              ...ProductSummaryFields\n            }\n          }\n        }\n      }\n    ": types.DuplicateCandidatesDocument,
    "\n      mutation RenameGenericProduct($productId: ID!, $name: String!) {\n        renameGenericProduct(productId: $productId, name: $name) {\n          ...ProductSummaryFields\n        }\n      }\n    ": types.RenameGenericProductDocument,
    "\n      mutation MergeProducts($sourceId: ID!, $targetId: ID!) {\n        mergeProducts(sourceId: $sourceId, targetId: $targetId) {\n          ...ProductSummaryFields\n        }\n      }\n    ": types.MergeProductsDocument,
    ...
    "\n      mutation SetFeedbackQuarantined($id: ID!, $quarantined: Boolean!) {\n        setFeedbackQuarantined(id: $id, quarantined: $quarantined)\n      }\n    ": types.SetFeedbackQuarantinedDocument,
    ...
    "\n      mutation FlagReview($recordId: ID!, $reason: String) {\n        flagRecord(recordType: REVIEW, recordId: $recordId, reason: $reason) {\n          flagCount\n          hidden\n        }\n      }\n    ": types.FlagReviewDocument,
    "\n      query PriceHistory($productId: ID!, $priceKind: PriceKind, $days: Int) {\n        priceHistory(productId: $productId, priceKind: $priceKind, days: $days) {\n          priceKind\n          days\n          currency\n          displayCurrency\n          rateAttribution\n          store {\n            ...StoreFields\n          }\n          points {\n            day\n            priceAmount\n            unitPrice\n            nObs\n            storeCount\n            convertedUnitPrice\n            convertedPriceAmount\n          }\n        }\n      }\n    ": types.PriceHistoryDocument,
    "\n      mutation RateProduct($productId: ID!, $stars: Int!) {\n        rateProduct(productId: $productId, stars: $stars) {\n          average\n          count\n        }\n      }\n    ": types.RateProductDocument,
    "\n      query ProductReviews($productId: ID!, $first: Int, $offset: Int) {\n        productReviews(productId: $productId, first: $first, offset: $offset) {\n          totalCount\n          hasMore\n          loginRequired\n          items {\n            ...ProductReviewFields\n          }\n        }\n      }\n    ": types.ProductReviewsDocument,
    "\n      mutation SaveProductReviewText($productId: ID!, $text: String!) {\n        saveProductReviewText(productId: $productId, text: $text) {\n          stars\n          text\n          updatedAt\n        }\n      }\n    ": types.SaveProductReviewTextDocument,
    "\n      mutation DeleteProductReviewText($productId: ID!) {\n        deleteProductReviewText(productId: $productId) {\n          stars\n          text\n          updatedAt\n        }\n      }\n    ": types.DeleteProductReviewTextDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n      query FeedbackChallenge {\n        feedbackChallenge {\n          token\n          salt\n          difficulty\n        }\n      }\n    "): typeof import('./graphql').FeedbackChallengeDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  fragment ProductReviewFields on ProductReview {\n    id\n    stars\n    text\n    authorPublicUid\n    authorName\n    createdAt\n    updatedAt\n    mine\n  }\n"): typeof import('./graphql').ProductReviewFieldsFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n      query DuplicateCandidates($first: Int, $offset: Int) {\n        duplicateCandidates(first: $first, offset: $offset) {\n          totalCount\n          items {\n            score\n            left {\n              ...ProductSummaryFields\n            }\n            right {\n              ...ProductSummaryFields\n            }\n          }\n        }\n      }\n    "): typeof import('./graphql').DuplicateCandidatesDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n      mutation RenameGenericProduct($productId: ID!, $name: String!) {\n        renameGenericProduct(productId: $productId, name: $name) {\n          ...ProductSummaryFields\n        }\n      }\n    "): typeof import('./graphql').RenameGenericProductDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n      mutation MergeProducts($sourceId: ID!, $targetId: ID!) {\n        mergeProducts(sourceId: $sourceId, targetId: $targetId) {\n          ...ProductSummaryFields\n        }\n      }\n    "): typeof import('./graphql').MergeProductsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n      mutation SetFeedbackQuarantined($id: ID!, $quarantined: Boolean!) {\n        setFeedbackQuarantined(id: $id, quarantined: $quarantined)\n      }\n    "): typeof import('./graphql').SetFeedbackQuarantinedDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n      query MyReviews($first: Int, $offset: Int) {\n        myReviews(first: $first, offset: $offset) {\n          totalCount\n          items {\n            stars\n            text\n            createdAt\n            updatedAt\n            hidden\n            product {\n              ...ProductSummaryFields\n            }\n          }\n        }\n      }\n    "): typeof import('./graphql').MyReviewsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n      mutation FlagReview($recordId: ID!, $reason: String) {\n        flagRecord(recordType: REVIEW, recordId: $recordId, reason: $reason) {\n          flagCount\n          hidden\n        }\n      }\n    "): typeof import('./graphql').FlagReviewDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n      mutation SaveProductReviewText($productId: ID!, $text: String!) {\n        saveProductReviewText(productId: $productId, text: $text) {\n          stars\n          text\n          updatedAt\n        }\n      }\n    "): typeof import('./graphql').SaveProductReviewTextDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n      mutation DeleteProductReviewText($productId: ID!) {\n        deleteProductReviewText(productId: $productId) {\n          stars\n          text\n          updatedAt\n        }\n      }\n    "): typeof import('./graphql').DeleteProductReviewTextDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
