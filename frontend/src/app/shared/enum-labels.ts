...
export const ERROR_CODE_KEYS: Record<ErrorCode, string> = {
  ...
  [ErrorCode.ProductNameLangUnsupported]: 'errors.PRODUCT_NAME_LANG_UNSUPPORTED',
  [ErrorCode.ProductNameLangDuplicate]: 'errors.PRODUCT_NAME_LANG_DUPLICATE',
  [ErrorCode.ProductNameEditSingleLang]: 'errors.PRODUCT_NAME_EDIT_SINGLE_LANG',
  ...
  [ErrorCode.ProductTooManyUnconfirmed]: 'errors.PRODUCT_TOO_MANY_UNCONFIRMED',
